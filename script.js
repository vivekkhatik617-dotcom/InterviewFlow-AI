    ...
    try {
        ...
        if (typeof report === "string") {
            ...
            try {
                ...
                console.error("JSON Parse Error:", report);

                result.innerHTML = `
    <div class="resume-card">
        <h2>⚠ Invalid AI Response</h2>
...
`;
        ...
        <div class="resume-card">
            ...
            <p>Please try again after 30 seconds.</p>
        </div>
        `;
    }
