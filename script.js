...
function updateBranchOptions() {
    ...
    branchData[branch].categories.forEach(category => {
...
function startTimer() {
    ...
    timerInterval = setInterval(() => {
        ...
        if (timeLeft <= 0) {
            clearInterval(timerInterval);
            timeTaken = totalTime;
            showToast("⏰ Time Up! Submit your answer.");
        }
    }, 1000);
}
    ...
    <div class="score-card">
        ...
        <div class="score-circle">
            ...
            <div class="score-content">
                ...
                <div class="score-value">${result.score || 90}</div>
